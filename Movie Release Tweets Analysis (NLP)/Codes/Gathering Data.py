...
''' Credentials from Twitter dev. and Google spreadsheet.
    This file should be in the same directory as the credential and config files
    for the next line of code to work. '''
...
class listener(tweepy.StreamListener):
    def on_data(self, data):
        ...
        with open('wonder_woman_movie_tweets.csv', 'a', encoding = 'utf-8') as f:
             ...
             df = pd.read_csv('wonder_woman_movie_tweets.csv')
             #print(df)
        ...
        def _get_worksheet(
            key: str,
            worksheet_name: str,
            creds: 'link to local folder containing the json credentials file' = 'name of json file (.json)',
            ) -> gspread.Worksheet:
...
if __name__ == "__main__":
    ...
    while True:
        try:
            ...
            '#Wonderwomanmovie', '#WonderWoman84', '#wonderwoman84', '#WONDERWOMAN84', '#Wonderwoman84', 'Wonder Woman 1984', 'wonder woman 1984']) 
